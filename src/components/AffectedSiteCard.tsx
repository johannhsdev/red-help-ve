...
import type { AffectedSite, AffectedSiteUrgency } from "../types/registry"
import { Badge } from "./ui/Badge"

const urgencyLabel: Record<AffectedSiteUrgency, string> = {
  low: "Baja",
  medium: "Media",
  high: "Alta",
  critical: "Crítica",
...
const urgencyClass: Record<AffectedSiteUrgency, string> = {
...
export function AffectedSiteCard({ site }: { site: AffectedSite }) {
