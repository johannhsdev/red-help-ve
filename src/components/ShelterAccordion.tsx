...
import type { Shelter, ShelterPerson, ShelterPersonDraft } from "../types/registry"
...
function personMatches(person: ShelterPerson, query: string) {
...
export function ShelterAccordion({
  ...
  shelter: Shelter
  query: string
  onAddPerson: (shelterId: number, person: ShelterPersonDraft) => Promise<ShelterPerson>
  onUpdatePersonVerification: (personId: number, patch: VerificationPatch) => Promise<ShelterPerson>
}) {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const draft: ShelterPersonDraft = {
