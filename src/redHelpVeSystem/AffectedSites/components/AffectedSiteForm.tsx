...
import type { IAffectedSite, IAffectedSiteDraft, IAffectedSiteUrgency } from "../../../Interfaces/IAffectedSite"
import { geocodeVenezuelaReference } from "../../../lib/geocoding"

const urgencyOptions: { value: IAffectedSiteUrgency; label: string }[] = [
...
export function AffectedSiteForm({
  onAdd,
}: {
  onAdd: (site: IAffectedSiteDraft, photoFile: File) => Promise<IAffectedSite>
}) {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const urgency = String(form.get("urgency") || "medium") as IAffectedSiteUrgency
    const draft: IAffectedSiteDraft = {
