...
import { AffectedSiteForm } from "./AffectedSiteForm"
...
export function AffectedSiteList({
  sites,
  loaded,
  error,
  onAdd,
  ...
  loaded: boolean
  error: string
  onAdd: (draft: IAffectedSiteDraft, photoFile: File) => Promise<IAffectedSite>
}) {
